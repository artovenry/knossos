<template lang="pug">
  #design4(style="background: white;")
    #top(style="background: white;display: flex;justify-content:center;align-items: center;margin-top:1rem;")
      svg(viewBox="0 0 1600 800" width="1600px" style="background: white;width: 95vw;border: 1px solid #AAA;")
...
<script lang="coffee">
  import StrokePath from "./Five/StrokePath.vue"
  export default
    filters:
